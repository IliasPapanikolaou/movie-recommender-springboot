package com.unipi.movierecommenderspringboot.commons;
 ...
 * 
 * <PRE>
 * URLResource ur = new URLResource("http://www.example.com/");
 ...
 * 
 * <PRE>
 * URLResource ur = new URLResource("http//example.csv");
